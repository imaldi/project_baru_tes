...
import 'package:project_baru_tes/screen/splash_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (ctx) => LoginCubit(repo: LoginRepository()),
        ),
        BlocProvider(
          create: (ctx) => RegisterCubit(repo: RegisterRepository()),
        ),
      ],
      child: MaterialApp(
        title: 'Flutter Test Aoo',
